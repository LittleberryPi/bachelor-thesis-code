  .text
  .globl  nttlevel6               // -- Begin function nttlevel6
  .p2align  2
  .type  nttlevel6,@function
nttlevel6:                              // @nttlevel6
  .cfi_startproc
.Lcfi0:
...
.init:
  ...
  mov     x15, #2                     //counter for zetas
  mov     x16, #3                     //second counter for zetas
...
.loop:
  ...
  add     x14, x12, x16, lsl #1        //address zeta for p_highU
  ld1rh   {z14.s}, p0/z, [x13]         //load zeta for p_highL
  ld1rh   {z2.s}, p0/z, [x14]          //load zeta for p_highU
