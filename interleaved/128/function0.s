  .text
  .globl  nttlevel0               // -- Begin function nttlevel0
  .p2align  2
  .type  nttlevel0,@function
nttlevel0:                              // @nttlevel0
  .cfi_startproc
.Lcfi0:
...
.loop:
  ...
  uunpklo z14.s, z2.h                 //zeta for p_highL
  uunpkhi z2.s, z2.h                  //zeta for p_highU

  //Get array p in the right format (interleave)
  add     x11, x0, x8, lsl #1         //x11 = address of p[0]
  ld1h    {z5.h}, p1/z, [x11, x10, lsl #1]  //z5 = p2
  ld1h    {z11.h}, p1/z, [x0, x8, lsl #1]    //z7 = p1
  uzp1    z13.h, z11.h, z5.h          //create the new p_low
  uzp2    z5.h, z11.h, z5.h           //create the new p_high

  //Compute t
  uunpklo z6.s, z5.h                  //z6 = lower half of z5 (p_high), zero extended
  uunpkhi z5.s, z5.h                  //z5 = upper half of z5 (p_high), zero extended
  ...
  add     z8.h, z13.h, z5.h           //z8 = barrett_param
  lsr     z9.h, z8.h, #13             //z9 = u = barrett_param >> 13
  mul     z9.h, p1/m, z9.h, z4.h      //z9 = u = u * KYBER_Q
  sub     z8.h, z8.h, z9.h            //z8 = barrett_param - u

  //Compute the new p_low
  add     z6.h, z13.h, z6.h           //z6 = barrett_param2
