...
nttlevel4:                              // @nttlevel4
  .cfi_startproc
.Lcfi0:
  .cfi_def_cfa_offset 0 //In the comments: U = upper half of array, L = lower half of array

.init:
  ptrue   p0.s                        //set the elements of P0 to true
  mov     x8, xzr                     //x8 = 0 (32 bits)
  mov     x15, #8                     //counter for zetas
  mov     x16, #9                     //second counter for zetas
  ...
  mov     z3.h, w10                   //z3 = w10 = 30724 = 4*KYBER_Qd
  mov     x10, #32                    //x10 = 32
  whilelo p1.h, xzr, x9               //while 0 < x9, procee

.loop:
  //Load zetas
  add     x13, x12, x15, lsl #1        //address zeta for pL
  add     x14, x12, x16, lsl #1        //address zeta for pU
  ld1rh   {z14.s}, p0/z, [x13]         //load zeta for pL
  ld1rh   {z2.s}, p0/z, [x14]          //load zeta for pU
  ...
  uunpklo z11.s, z13.h
  uunpklo z12.s, z5.h
  uzp1    z11.h, z11.h, z12.h         //create the new p_low
  uunpkhi z13.s, z13.h
  uunpkhi z5.s, z5.h
  uzp1    z13.h, z13.h, z5.h          //create the new p_high
  ...
  uunpklo z13.s, z10.h
  uunpklo z14.s, z8.h
  uzp1    z12.h, z13.h, z14.h         //original p1 format
  uunpkhi z13.s, z10.h
  uunpkhi z14.s, z8.h
  uzp1    z11.h, z13.h, z14.h         //original p2 format
  ...
  inch    x8
  add     x15, x15, #2                //to load in next part of zetas
  add     x16, x16, #2
