...
.init:
  ...
  add  w5, w9, #1                   //w5 = w9 + 1 = zeta_counter
...
.loop1:
  ...
  ld1h  {z7.h}, p1/z, [x0, x8, lsl #1]    //z7 = x0 = p_low
  ...
  st1h  {z10.h}, p1, [x0, x8, lsl #1]       //store barrett_param2 in p_low
...
ld1rh  {z2.s}, p0/z, [x15]          //broadcast x10 to z2 = zeta
add  w5, w5, #1                     //w5 = w5 + 1 = zeta_counter
mov  x8, xzr                        //x8 = 0 (32 bits)
mov  x10, #192                      //x10 = 192 (3/4 size(p))
